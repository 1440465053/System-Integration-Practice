...
def writehashRange(p4info_helper, ingress_sw, egress_sw, match_fields, action_params)
...
def writenextHop(p4info_helper, ingress_sw, egress_sw, match_fields, action_params)
	table_entry = p4info_helper.buildTableEntry(
        table_name="MyIngress.ecmp_nhop",
        match_fields={"meta.ecmp_select": match_fields},
        action_name="MyIngress.set_nhop",
        action_params=action_params
    )
    ingress_sw.WriteTableEntry(table_entry)

def writemac(p4info_helper, ingress_sw, egress_sw, match_fields, action_params)
	table_entry = p4info_helper.buildTableEntry(
        table_name="MyEgress.send_frame",
        match_fields={"standard_metadata.egress_port": match_fields},
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        writenextHop(p4info_helper, s2, s2,
          0, {"nhop_dmac": "00:00:00:00:02:02", "nhop_ipv4": "10.0.2.2", "port": 1})
        writemac(p4info_helper, s2, s2,
        ...
        writenextHop(p4info_helper, s3, s3,
          0, {"nhop_dmac": "00:00:00:00:03:03", "nhop_ipv4": "10.0.3.3", "port": 1})
        writemac(p4info_helper, s3, s3,
